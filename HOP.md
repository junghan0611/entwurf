...
1. **D5 — H7 live-cutover entry blocker:** 최초 live M1 전에 live old writer quiesce를 강제할 operator 절차/actuator와 detector를 GLG가 확정한다. 현재 doctor는 stale deployed writer를 검출하지만 quiesce actuator는 없다. H2 rehearsal과 post-G1 #51 doctor delta가 선택 근거를 낸다.
