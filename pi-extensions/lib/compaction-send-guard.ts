 ...
 *
 * Pi has no public `ExtensionContext.isCompacting()`. `[측정 2026-09-20, pi 0.86.0]` and
 * re-measured `[측정 2026-09-22, pi 0.87.0]` and `[측정 2026-09-23, pi 0.87.1]`: the installed
 * `dist/core/extensions/types.d.ts` declares `isIdle(): boolean` at :233 and `signal` at :237 —
 * the SAME coordinates at all three floors — and carries no `isCompacting` member at all (grep
 * count 0, re-counted on 0.87.1); the identifier exists
