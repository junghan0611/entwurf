...
| pi | optional, `@earendil-works/pi-coding-agent >=0.84.0 <0.85` | ACP provider, control sockets |
...
The supported range is `>=0.84.0 <0.85`. It is a hard minimum: installing this
