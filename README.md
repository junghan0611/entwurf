...
already installed — a compatible `pi` (`>=0.87.0 <0.88`), Claude Code, agy, and the Copilot CLI
...
separately (`@earendil-works/pi-coding-agent >=0.87.0 <0.88`). Then point pi at
