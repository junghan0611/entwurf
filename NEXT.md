...
- ▶ **NEXT (in order):** (1) Step 2 dep bump (verified by release-gate); (2) Step 3 Opus 4.8; (3) Step 4 docs; (4) Step 5 cut. **No remaining release-blockers in the gate plumbing; GLG closes the final 0.8.0 authorization after a green full `./run.sh release-gate` (run from a scratch cwd, gemini included).**
