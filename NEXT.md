...
> - **다음 한 걸음:** GLG 커밋 결정(B 단독 커밋) → CHANGELOG(0.11.0 스코프 확정) → tag-release. **(A)+(B) = 0.11.0 acceptance 2 blocker 모두 해소.**
