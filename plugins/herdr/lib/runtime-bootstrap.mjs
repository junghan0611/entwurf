/**
 * runtime-bootstrap — the Entwurf-owned runtime this plugin installs against (#116 M3-b1).
 *
...
/** The checkout this plugin was installed from: `<checkout>/plugins/herdr/lib/` is where we live. */
export function defaultCheckoutRoot() {
	return path.resolve(path.dirname(fileURLToPath(import.meta.url)), "..", "..", "..");
}

/** `<checkout>/plugins/herdr` — where the manifest and the lock file live. */
